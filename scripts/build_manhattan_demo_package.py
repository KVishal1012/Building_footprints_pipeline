...
OUTPUT_DIR = REPO_ROOT / "demo_packages" / "manhattan_demo"
...
def build_release_manifest(rows: list[dict], coverage_rows: list[dict]) -> dict:
    """Build the release manifest for the Manhattan demo package."""
    ...
    return {
        ...
        "known_gaps": [
            ...
            "Production delivery requires current authoritative source acquisition for the requested city/AOI.",
...
def build_brief(manifest: dict) -> str:
    """Build the one-page implementation brief."""
    return f"""# One-Page Brief: Structure Intelligence Database
...
def main() -> None:
    """Build the reproducible Manhattan demo package."""
